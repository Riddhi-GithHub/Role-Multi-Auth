...
<section class="content">
    <div class="col-12">
        <div class="card p-2">            
            <a class="btn btn-primary mr-2 mt-2 mb-2" style="width: 170px; margin-left:auto;" href="{{ route('staf.create') }}">Add New Staf</a>
            <div>
                <table class="table table-bordered" style="font-family: Arial, Helvetica, sans-serif; font-size:16px;">
                    <thead>
                        <tr>
